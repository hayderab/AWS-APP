  ...
  const uploadAndProcessFile = async () => {
    ...
    try {
      ...
      try {
        ...
        certificationData = await GeminiService.processPdfWithGemini(
          file.uri,
          file.name
        );
      } catch (geminiError) {
        ...
        certificationData = {
          ...
          imageUrl:
            "https://d1.awsstatic.com/training-and-certification/certification-badges/AWS-Certified-Machine-Learning-Engineer-Associate_badge.e5d66b50925b1b750b326f29b785529ccc82a696.png",
          topics: [
            {
              id: "topic-1",
              title: "Data Preparation for Machine Learning",
              description:
                "Learn how to ingest, transform, and prepare data for ML modeling.",
              subtopics: [
                {
                  id: "subtopic-1-1",
                  title: "Data Ingestion and Storage",
                  content:
                    "Techniques for ingesting and storing data for ML workloads.",
                  resources: [
                    {
                  ...
                  videoLinks: [
                    {
                      name: "Data Ingestion Best Practices",
                  ...
                  resources: [
                    {
                      ...
                      url: "https://docs.aws.amazon.com/sagemaker/latest/dg/feature-engineering.html",
                    },
                  ],
                  videoLinks: [
                    {
                      name: "Feature Engineering on AWS",
            ...
            },
            {
              ...
              description:
                "Techniques for selecting, training, and evaluating ML models.",
              subtopics: [
                {
                  id: "subtopic-2-1",
                  title: "Model Selection",
                  content:
                    "How to choose the right ML algorithm for your use case.",
                  resources: [
                    {
                      name: "SageMaker Algorithms",
                      url: "https://docs.aws.amazon.com/sagemaker/latest/dg/algos.html",
                    },
                  ],
                  videoLinks: [
                    {
                      name: "Choosing ML Models",
      ...
      try {
        ...
        const savedCertification = await ApiService.certification.create(
      ...
      try {
        ...
        const existingIndex = recentCerts.findIndex(
          (cert) =>
            cert.id === newCertificationData.id ||
            cert.title.toLowerCase() ===
              newCertificationData.title.toLowerCase()
        );
        ...
        if (topic.subtopics && topic.subtopics.length > 0) {
          for (const subtopic of topic.subtopics) {
            ...
            if (subtopicData.title && subtopicData.title.length > 100) {
              console.warn(
                `Subtopic title too long (${subtopicData.title.length} chars). Truncating to 100 characters.`
              );
            ...
            try {
              console.log(
                "Saving subtopic data:",
                JSON.stringify(subtopicData)
              );
              const savedSubtopic = await ApiService.subtopic.create(
                subtopicData
              );
              ...
              try {
                ...
                let subtopics = storedSubtopics
                  ? JSON.parse(storedSubtopics)
                  : [];
                ...
                console.error(
                  "Error saving subtopic to local storage:",
                  localError
                );
              }
            }
        ...
        [
          {
            ...
            onPress: () =>
              navigation.navigate("Home", {
                screen: "TopicList",
                params: { certification: newCertificationData },
              }),
          },
        ]
      );
      ...
      <Card style={styles.card}>
        <Card.Content>
          <Text variant="titleLarge" style={styles.title}>
            Upload AWS Certification Guide
          </Text>
          <Text variant="bodyMedium" style={styles.description}>
            Upload your AWS certification PDF guide to extract topics and create
            study materials.
          </Text>
          ...
          <View style={styles.uploadSection}>
            ...
            {file && (
              <View style={styles.filePreview}>
                ...
                {file.size && (
                  <Chip icon="file-pdf-box" style={styles.fileSize}>
        ...
        <Card.Content>
          ...
          <View style={styles.stepContainer}>
            ...
            <View style={styles.stepTextContainer}>
              ...
              <Text style={styles.stepDescription}>
                Google Gemini AI analyzes the PDF to extract topics and
                subtopics.
              </Text>
            </View>
          </View>
          ...
          <View style={styles.stepContainer}>
            ...
            <View style={styles.stepTextContainer}>
              ...
              <Text style={styles.stepDescription}>
                Access organized topics, take quizzes, and create notes to
